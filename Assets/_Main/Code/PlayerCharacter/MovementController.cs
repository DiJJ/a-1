...
public class MovementController
{
    ...
    public MovementController(float collisionRadius, float outerBounds, LayerMask collisionMask, float slopeLimit = 40f, int depthLimit = 3)
    {
    ...
    private Vector3 CollideAndSlide(Vector3 position, Vector3 velocity, int depth)
    {
        ...
        if (Physics.CapsuleCast(upperPoint, lowerPoint, m_collisionRadius, velocity.normalized, out RaycastHit hit, distance, m_collisionMask))
        {
